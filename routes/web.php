...
Route::middleware(['auth'])->group(function () {
    ...
    // ✅ FIX: VIEW ARCHIVED STUDENTS (THIS WAS MISSING)
    Route::get('/students/archived', [AdminController::class, 'archivedStudents']);

    // ✅ NEW: RESTORE STUDENT
    Route::get('/students/restore/{id}', [AdminController::class, 'restore']);
